$(document).ready(function () {
  ...
  var myCalendar = createCalendar({
    ...
    data: {
      // Event title
      title: "Đạt and Hồng Anh's Wedding",

      // Event start date
      start: new Date("Aug 5, 2023 10:30"),
      ...
      end: new Date("Aug 5, 2023 12:00"),

      // Event Address
      address: "Tầng 1, Happy Palace, Hải Đăng Plaza, đường Trần Khánh Dư, Hải Phòng",

      // Event Description
      description:
        "Thân mời bạn đến dự lễ cưới của chúng tớ! Mọi vấn đề xin liên hệ Đạt: 0789207003",
    },
  });
  ...
  $("#rsvp-form").on("submit", function (e) {
    ...
    // } else {
      $.post(
        "https://script.google.com/macros/s/AKfycbxygSqUTBrRTc0MjIjSYHJejVJ4ZzckMY_sZZ98eO3RWyWgnLGDu9ZWPTC0VjBL4wbX/exec",
        data
      )
